...
<body>
    <section>
        ...
        <section class="bg-white" style="height: 150vh;">
            <div class="text-center py-10"> <span class="text-black font-bold text-2xl"> </span>
            </div>
            <div class="bg-biru_tengah max-w-xl mt-5 py-8 mx-auto items-center justify-center rounded-xl " style="height: 150vh;">
